...
public class VisualiserCommandesATraiter extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Commande> listeCommande = commandeServiceEJBLocal.listerCommandesTrieParDateEtatFinalise();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Commande commandeUtilLogger = commandeServiceEJBLocal.rechercheParID(idCommande);
        commandeUtilLogger.setEtat(Commande.Etat.EXPEDIE);
        commandeServiceEJBLocal.modifierCommande(commandeUtilLogger);
